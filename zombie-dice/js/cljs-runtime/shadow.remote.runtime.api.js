...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14417 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14417(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_14422 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_14422(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_14424 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_14424(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_14426 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_14426(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14431 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14431(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14432 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14432(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__14413,callback){
var map__14415 = p__14413;
var map__14415__$1 = cljs.core.__destructure_map(map__14415);
var input = map__14415__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14415__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14415__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
