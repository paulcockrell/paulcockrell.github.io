...
var i_14451 = (self__.level + (1));
while(true){
if((i_14451 <= (new_level + (1)))){
(update[i_14451] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14458 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14458[i]));
} else {
x__$2.forward.push((((i < links_14458.length))?(links_14458[i]):null));
}

if((i < links_14458.length)){
(links_14458[i] = x__$2);
} else {
links_14458.push(x__$2);
}
...
var i_14469 = (0);
while(true){
if((i_14469 <= self__.level)){
var links_14470 = (update[i_14469]).forward;
if((x__$1 === (((i_14469 < links_14470.length))?(links_14470[i_14469]):null))){
(links_14470[i_14469] = (x__$1.forward[i_14469]));

var G__14471 = (i_14469 + (1));
i_14469 = G__14471;
continue;
} else {
var G__14472 = (i_14469 + (1));
i_14469 = G__14472;
continue;
}
} else {
