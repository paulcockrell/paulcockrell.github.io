...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12020 = c;
var G__12020__$1 = (((G__12020 == null))?null:G__12020.prototype);
if((G__12020__$1 == null)){
return null;
} else {
return G__12020__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12024 = c;
var G__12024__$1 = (((G__12024 == null))?null:G__12024.prototype);
if((G__12024__$1 == null)){
return null;
} else {
return G__12024__$1.render;
}
})() == null)))));
});
...
while (G__12113__i < G__12113__a.length) {G__12113__a[G__12113__i] = arguments[G__12113__i + 0]; ++G__12113__i;}
  args = new cljs.core.IndexedSeq(G__12113__a,0,null);
} 
...
var or__5002__auto__ = (function (){var G__12026 = c;
var G__12026__$1 = (((G__12026 == null))?null:G__12026.constructor);
if((G__12026__$1 == null)){
return null;
} else {
return G__12026__$1.displayName;
}
})();
...
var _STAR_current_component_STAR__orig_val__12030 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12031 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12031);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12030);
}});
...
var c = this;
var G__12090_12118 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__12090_12118 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12090_12118);
}
...
var renders_12119 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_12120 = cljs.core.first(cljs.core.vals(renders_12119));
...
if((cljs.core.count(renders_12119) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12119))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12120)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12120], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
